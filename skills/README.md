...
| `collect-brand-material` | Collecting a product's own brand and promotional material -- brand kit, store listings, social, newsroom -- and turning it into the `images` rows of a canvas folder. |
