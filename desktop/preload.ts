 ...
 * `agent` is the onboarding's answer, remembered for the next launch, and installs that agent's
 * skills into the project the window is on. `check` is a click on the onboarding's version. It
 * looks for an update and resolves to what to say beside the version.
