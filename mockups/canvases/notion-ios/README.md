...
finished board looks like. One measured token block plus six replica screens,
...
| file | what it is |
|---|---|
| `00-design-tokens.html` | The contract. Swatches, type ramp, radii, metrics, and the evidence for each value. Inlined byte-identically into all six screens. |
